...
},a.fn.circleProgress=function(c,d){var e="circle-progress",f=this.data(e);if("widget"==c){if(!f)throw Error('Calling "widget" method on not initialized instance is forbidden');return f.canvas}if("value"==c){if(!f)throw Error('Calling "value" method on not initialized instance is forbidden');if("undefined"==typeof d)return f.getValue();var g=arguments[1];return this.each(function(){a(this).data(e).setValue(g)})}return this.each(function(){var d=a(this),f=d.data(e),g=a.isPlainObject(c)?c:{};if(f)f.init(g);else{var h=a.extend({},d.data());"string"==typeof h.fill&&(h.fill=JSON.parse(h.fill)),"string"==typeof h.animation&&(h.animation=JSON.parse(h.animation)),g=a.extend(h,g),g.el=d,f=new b(g),d.data(e,f)}})}}),function(a){a("html").hasClass("ie")||a("select").each(function(){new CustomSelect(a(this))})}(jQuery),$(".icon_socialmedia").hover(function(){$(this).toggleClass("purple_background")}),function(){"use strict";function a(a){a.addEventListener("click",function(a){header_active(),this.classList.contains("is-active")===!0?this.classList.remove("is-active"):this.classList.add("is-active")})}for(var b=document.querySelectorAll(".c-hamburger"),c=b.length-1;c>=0;c--){var d=b[c];a(d)}}();var nextArrow=jQuery("#carouselNextArrow"),prevArrow=jQuery("#carouselPrevArrow");jQuery(".slick_carousel").on("init",function(a,b){jQuery(this).find(".slick-dots").appendTo(".slick-dots-container")}),$(".slick_carousel").slick({dots:!0,infinite:!0,speed:300,slidesToShow:1,slidesToScroll:1,mobileFirst:!0,autoplay:!0,prevArrow:prevArrow,nextArrow:nextArrow,dots:!0,responsive:[{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:2,infinite:!0}},{breakpoint:992,settings:{slidesToShow:3,slidesToScroll:3,settings:"unslick"}}]}),grunticon([pathToThemes.path+"/assets/dist/grunticon/icons.data.svg.css",pathToThemes.path+"/assets/dist/grunticon/icons.data.png.css",pathToThemes.path+"/assets/dist/grunticon/icons.fallback.css"]);
