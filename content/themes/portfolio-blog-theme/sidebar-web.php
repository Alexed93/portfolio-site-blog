...
<aside class="sidebar | cf" role="complementary">
    <article class="sidebar__section">
        <div class="sidebar--text">
            ...
            <h3 class="u-push-top/2">As a front-end developer, a lot of my side projects involve trying out the latest in web trends, new plugins and generally increasing my coding knowledge. Some of these projects can also be found on <a href="#">my CodePen.</a></h3>
        </div>
