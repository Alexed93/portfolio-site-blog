...
<aside class="sidebar | cf" role="complementary">
    <article class="sidebar__section">
        <div class="sidebar--text">
            ...
            <h3 class="u-push-top/2"> Here, you can view some of my side projects, doodles and scribbles. I also occasionally blog about what i've been up to, on screen and off. 
            Don't forget to check out my portfolio, or say Hi in the comments or by email.</h3>
        </div>
